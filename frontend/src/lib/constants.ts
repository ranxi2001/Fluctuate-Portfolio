...
export const SUPPORTED_ASSETS = [
  { symbol: 'BTC', name: 'Bitcoin', category: 'crypto', decimals: 8, hasPriceFeed: true },
  { symbol: 'ETH', name: 'Ethereum', category: 'crypto', decimals: 18, hasPriceFeed: true },
  { symbol: 'USDT', name: 'Tether USD', category: 'stablecoin', decimals: 6, hasPriceFeed: false, fixedPrice: 1 },
  { symbol: 'USDC', name: 'USD Coin', category: 'stablecoin', decimals: 6, hasPriceFeed: false, fixedPrice: 1 },
  { symbol: 'XAU', name: 'Gold', category: 'rwa', decimals: 8, hasPriceFeed: true },
  { symbol: 'USD', name: 'US Dollar', category: 'fiat', decimals: 2, hasPriceFeed: false, fixedPrice: 1 },
  { symbol: 'CNY', name: 'Chinese Yuan', category: 'fiat', decimals: 2, hasPriceFeed: false, fixedPrice: 0.14 },
] as const
